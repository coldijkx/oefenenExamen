...
$name = $address = $salary = $aantal = "";
$name_err = $address_err = $salary_err = $aantal_err = "";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err) && empty($aantal_err)){
        // Prepare an insert statement
        $sql = "UPDATE employee SET name=?, address=?, salary=?, aantal=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssssi", $param_name, $param_address, $param_salary, $param_aantal, $param_id);
